...
//		    text_khxl, 
			...
			text_kzzd2, text_ddsj, text_wcsj, text_czy, text_czsj,text_kzzd6,text_xxdz;
...
//		text_khxl = (TextView) findViewById(R.id.text_khxl);
		...
		text_xxdz = (TextView) findViewById(R.id.text_xxdz);
...
//		text_bzrlxdh.setText(itemmap.get("bzrlxdh"));
		...
		text_xxdz.setText(itemmap.get("khxxdz"));
