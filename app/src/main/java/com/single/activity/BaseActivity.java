...
import com.single.utils.MySimpleAdapter;
...
//		finish();
	...
	protected void dialogShowLBZ(OnClickListener confirmListener) {
		View view = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.include_lbz, null);
		AlertDialog.Builder builder = new Builder(this);
		builder.setCancelable(false);
	...
	protected void dialogShowMessage(String message,
		...
		builder.setTitle("提示");
		builder.setPositiveButton("确认", confirmListener);
		builder.setNegativeButton("取消", canlListener==null?new DialogInterface.OnClickListener() {
				...
				.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					...
					public void onCheckedChanged(RadioGroup Group, int id) {
						...
						RadioButton localRadioButton = (RadioButton) inputwindow
								.findViewById(id);
						searchC = (EditText) inputwindow.findViewById(R.id.searchC);
