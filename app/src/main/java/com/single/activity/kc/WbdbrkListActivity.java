...
public class WbdbrkListActivity extends FrameActivity {
	...
	protected void initListeners() {
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int index,
				...
				Intent intent = new Intent(WbdbrkListActivity.this,WbdbrkActivity.class);
	...
	protected void getWebService(String s) {
		...
		if ("query".equals(s) && !backboolean) {
			try {
				JSONObject jsonObject = callWebserviceImp.getWebServerInfo("_PAD_DBRK_CX1",
						DataCache.getinition().getUserId()+"*"+DataCache.getinition().getUserId(),
